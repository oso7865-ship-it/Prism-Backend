...
| 부착 프로젝트 최신 | [프로젝트 Report](../../reports/2026-09-25_publish-identity_report.md) | 인증·팀 6개 ORM/migration 및 로컬 Docker PostgreSQL 검증 완료. 게시·CI 상태는 연결된 Report 참조. 하네스 동기화 보류 |
